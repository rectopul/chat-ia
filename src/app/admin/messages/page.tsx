                ...
                <Table>
                    <TableHeader className="bg-slate-50/50">
                        <TableRow className="hover:bg-transparent border-slate-100">
                            <TableHead className="font-bold text-slate-700">Key / Título</TableHead>
                            <TableHead className="font-bold text-slate-700">Tipo</TableHead>
                            <TableHead className="font-bold text-slate-700">Conteúdo</TableHead>
                    ...
                    <TableBody>
                        {templates.map((t) => (
                            <TableRow key={t.id} className="border-slate-50 hover:bg-slate-50/30 transition-colors">
                                <TableCell className="max-w-[300px]">
                                    <div className="flex flex-col gap-1">
                                        <Badge variant="outline" className="w-fit text-[9px] font-bold uppercase tracking-wider py-0 px-1.5 border-slate-200 text-slate-500">
                                            {t.key}
                                        </Badge>
                                ...
                                <TableCell>
                                    <Badge className="bg-blue-50 text-blue-700 border-blue-100 hover:bg-blue-50 shadow-none font-bold text-[10px]">
                                        {t.type === "COMBO" ? <Layers className="w-3 h-3 mr-1" /> : <FileText className="w-3 h-3 mr-1" />}
                                        {t.type}
                                    </Badge>
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell>
                                    <form action={toggleTemplate.bind(null, t.id, t.isActive)}>
