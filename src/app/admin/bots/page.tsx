        ...
        <div className="space-y-8">
            <div className="bg-white p-6 rounded shadow-sm">
                ...
                >
                    <input
                        name="name"
                        placeholder="Nome do Bot (ex: Bot VIP 1)"
                        className="p-2 border rounded"
                        required
                    />
                    <input
                        name="token"
                        placeholder="Bot Token do BotFather"
                        className="p-2 border rounded"
                        required
                    />
                    <input
                        name="webhookSecret"
                        placeholder="Webhook Secret (qualquer string)"
                        className="p-2 border rounded"
                        required
                    />
                    <button
                        type="submit"
                        className="md:col-span-3 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700"
                    >
                        Salvar Bot
                    </button>
                </form>
                        ...
                        {bots.map((bot) => (
                            <tr key={bot.id}>
                                ...
                                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 space-x-2">
                                    <form
                                        action={setWebhook.bind(null, bot.id)}
                                        className="inline"
                                    >
                                        <button
                                            type="submit"
